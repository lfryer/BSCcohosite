    <link rel="stylesheet" type="text/css" media="all" href="whoweare/css/font-awesome.min.css" />
    <link rel="stylesheet" type="text/css" media="all" href="whoweare/css/jgallery.min.css" />
    <script type="text/javascript" src="whoweare/js/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="whoweare/js/tinycolor-0.9.16.min.js"></script>
    <script type="text/javascript" src="whoweare/js/jgallery.min.js"></script>
